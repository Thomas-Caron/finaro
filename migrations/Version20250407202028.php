...
final class Version20250407202028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE `account_movement` (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, label_id INT NOT NULL, movement_type_id INT NOT NULL, year_id INT NOT NULL, month_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_8C1377419B6B5FBA (account_id), INDEX IDX_8C13774133B92F39 (label_id), INDEX IDX_8C137741EA4ED04A (movement_type_id), INDEX IDX_8C13774140C1FEA7 (year_id), INDEX IDX_8C137741A0CBDE4 (month_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE `label` (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_EA750E8989D9B62 (slug), INDEX IDX_EA750E8B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
