<template>
    <div class="rounded-lg relative flex flex-wrap items-center p-2 bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-700 group">
        <button
            v-if="actions.move"
            type="button"
        ...
        <button
            ...
            @click.stop="!actions.removeConfirm ? emit('delete') : ''"
        >
