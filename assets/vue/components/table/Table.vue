<template>
    ...
    >
        ...
        >
            ...
            <tbody>
                ...
                >
                    ...
                    >
                        <span
                            v-if="column.key === 'color'"
                            class="w-8 h-8 rounded-lg block border border-stone-300 dark:border-stone-500"
                            :style="`background-color: ${row[column.key]};`"
                        ></span>
                        <span
                            v-else-if="column.key === 'icon'"
                            class="w-8 h-8 rounded-lg flex items-center justify-center border border-stone-300 dark:border-stone-500"
                        >
                            <Icon :name="row[column.key]" class="size-5 text-stone-500 dark:text-stone-400" />
                        </span>
        ...
        <div v-else class="w-full relative flex items-center justify-center py-5 text-stone-500 dark:text-stone-400 bg-stone-50 dark:bg-stone-900">
