...
const buildOptions = (data) => ({
    ...
    tooltip: {
        ...
        custom: function({ series, seriesIndex, dataPointIndex }) {
            ...
            const capital = getCurrency(data.capital[dataPointIndex]);
            const saving = getCurrency(data.saving[dataPointIndex]);
            const interest = getCurrency(data.interest[dataPointIndex]);
