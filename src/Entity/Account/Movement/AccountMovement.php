...
namespace Finaro\Entity\Account\Movement;

use Doctrine\ORM\Mapping as ORM;
use Doctrine\DBAL\Types\Types;
use Finaro\Entity\Account\Account;
use Finaro\Entity\Date\Month;
use Finaro\Entity\Date\Year;
use Finaro\Entity\Label\Label;
use Finaro\Repository\Account\Movement\AccountMovementRepository;
